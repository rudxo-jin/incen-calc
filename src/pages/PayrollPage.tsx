...
export function PayrollPage() {
    ...
    const updatePayrollMutation = useMutation({
        mutationFn: async (values?: Record<string, number>) => {
            ...
            // 2. Call RPC for Batch Update & Recalculation
            if (itemUpdates.length > 0) {
                const { error } = await supabase.rpc('update_payroll_batch', {
                    p_updates: itemUpdates
                });
                if (error) throw error;
            }
        },
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-9 pr-4 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500 w-48 ime-active"
                                lang="ko"
                            />
                        </div>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-9 pr-4 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500 w-32 ime-active"
                                lang="ko"
                            />
                        </div>
                        <select
