...
import { Calculator, History, Users, Settings, BarChart3, LogOut, FileText } from 'lucide-react';
...
export function Layout() {
    ...
    const navItems = [
        ...
        { path: '/payroll', label: '급여 대장', icon: FileText },
        { path: '/salary-components', label: '수당/공제 관리', icon: BarChart3 },
